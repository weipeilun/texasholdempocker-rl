...
if __name__ == '__main__':
    ...
    game_finalized_signal_queue1 = Manager().Queue()
    ...
    if batch_predict_model_type == ModelType.TENSORRT:
        ...
        # data_out_queue
        predict_batch_out_queue_list = [One2ManyQueue([model_param_dict['num_output_class'], ], np.float32(), n_consumers_over_process=num_train_eval_process, n_consumers_in_process=num_game_loop_thread_per_process, max_queue_size=num_train_eval_thread) for _ in range(num_predict_batch_process)]
